  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-8">
      <div className="relative">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-12 md:hidden">
          {/* Name and titles */}
        ...
        <div className="hidden md:flex items-center justify-center space-x-24">
          ...
          <div className="flex flex-col items-center space-y-8 animate-fade-in-delayed-3" onClick={() => handleNavigate(urlPhotogrphy)} >
            ...
            {/* Connection line */}
            <div className="h-px w-32 bg-gradient-to-r from-transparent via-primary to-transparent animate-draw-line origin-right"></div>
          </div>
        </div>
      </div>
    </div>
